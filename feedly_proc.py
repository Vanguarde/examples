# Пример кода на Python, который обрабатывает СМИ с Feedly, вычленяет текст новости из кода, лемматизирует текста и добавляет все в БД. 
# Тут лишь некоторые части кода, некоторые функции здесь отсутствуют, либо получены из других файлов py
